...
if [ ! -f "loader.sh" ]; then
    ...
    wget -O loader.sh https://raw.githubusercontent.com/0xs3nat0r/multiple-network/refs/heads/main/utils/loader.sh
    chmod +x loader.sh
    ./loader.sh
else
...
curl -s https://raw.githubusercontent.com/0xs3nat0r/multiple-network/refs/heads/main/utils/logo.sh | bash
sleep 2
...
echo "Github: https://github.com/0xs3nat0r"
